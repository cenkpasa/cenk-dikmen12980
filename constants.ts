...
export const MESSAGES: Record<string, Record<string, string>> = {
    tr: {
        ...
        'summarySaved': 'Yapay zeka özeti başarıyla oluşturuldu.',
...
export const MOCK_CUSTOMERS: Omit<Customer, 'id' | 'createdAt'>[] = [
    ...
    { name: "Demir Export", commercialTitle: "Demir Export Madencilik", email: "export@demir.com", phone1: "0212 444 30 40", address: "İstanbul Dünya Ticaret Merkezi", notes: "Yeni pazarlara açılmak istiyorlar. Lojistik konusunda destek lazım." },
    { name: "Güneş Enerji Sistemleri", email: "info@gunesenerji.com", phone1: "0232 333 50 60", notes: "Son görüşmede yeni panel teknolojileriyle ilgilendiklerini belirttiler. Bir sunum ayarlanabilir." },
    { name: "Yıldız Mobilya", commercialTitle: "Yıldız Mobilya Dekorasyon Ltd. Şti.", email: "siparis@yildizmobilya.net", phone1: "0224 222 80 90", address: "Bursa Mobilya Sanayi Sitesi", notes: "" },
    { name: "Anadolu Gıda", phone1: "0332 111 70 80", notes: "Soğuk hava deposu çözümleri için tekrar iletişime geçilecek." }
];

export const MOCK_APPOINTMENTS: Omit<Appointment, 'id' | 'createdAt' | 'userId'>[] = [
    { customerId: "1", title: "Proje Değerlendirme Toplantısı", start: new Date(new Date().setDate(new Date().getDate() + 1)).toISOString(), end: new Date(new Date().setDate(new Date().getDate() + 1)).toISOString() },
    { customerId: "3", title: "Yeni Panel Teknolojileri Sunumu", start: new Date(new Date().setDate(new Date().getDate() + 3)).toISOString(), end: new Date(new Date().setDate(new Date().getDate() + 3)).toISOString() },
    { customerId: "5", title: "Takip Araması - Soğuk Hava Deposu", start: new Date(new Date().setDate(new Date().getDate() - 2)).toISOString(), end: new Date(new Date().setDate(new Date().getDate() - 2)).toISOString() },
];

export const MOCK_ERP_STOCK_ITEMS: StockItem[] = [
    { id: 'STK-001', name: 'CNC Torna Ucu - Tip A', quantity: 150, price: 75.50, lastSync: new Date().toISOString() },
    { id: 'STK-002', name: 'Freze Bıçağı - 10mm', quantity: 80, price: 120.00, lastSync: new Date().toISOString() },
    { id: 'STK-003', name: 'Matkap Ucu - HSS 5mm', quantity: 500, price: 15.75, lastSync: new Date().toISOString() },
    { id: 'STK-004', name: 'Soğutma Sıvısı - 5L', quantity: 40, price: 250.00, lastSync: new Date().toISOString() },
];

export const MOCK_ERP_INVOICES: Invoice[] = [
    { id: 'FAT-2024-001', customerId: '1', userId: 'user-cnk', date: new Date().toISOString(), totalAmount: 15250.00, items: [{ stockId: 'STK-001', quantity: 50, price: 75.50 }] },
    { id: 'FAT-2024-002', customerId: '2', userId: 'user-cnk', date: new Date(new Date().setMonth(new Date().getMonth() - 1)).toISOString(), totalAmount: 8500.00, items: [] },
    { id: 'FAT-2024-003', customerId: '4', userId: 'user-cnk', date: new Date().toISOString(), totalAmount: 22000.00, items: [] },
];

export const MOCK_ERP_CUSTOMERS: Omit<Customer, 'id' | 'createdAt'>[] = [
    { name: "ERP Müşteri A", email: "erpa@example.com", phone1: "03121112233", taxOffice: "Ankara" },
    { name: "ERP Müşteri B", email: "erpb@example.com", phone1: "02121112233", taxOffice: "İstanbul" }
];
